...
bool transResultInfo (TER code, std::string& token, std::string& text)
{
    ...
    TxResultInfo const results[] =
    {
        ...
        { tecNO_DST,                "tecNO_DST",                "Destination does not exist. Send XDV to create it."            },
        { tecNO_DST_INSUF_XDV,      "tecNO_DST_INSUF_XDV",      "Destination does not exist. Too little XDV sent to create it." },
        ...
        { tecUNFUNDED_ADD,          "tecUNFUNDED_ADD",          "Insufficient XDV balance for WalletAdd."                       },
        { tecUNFUNDED_OFFER,        "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                   },
        { tecUNFUNDED_PAYMENT,      "tecUNFUNDED_PAYMENT",      "Insufficient XDV balance to send."                             },
        ...
        { temBAD_FEE,               "temBAD_FEE",               "Invalid fee, negative or not XDV."                             },
        ...
        { temBAD_SEND_XDV_LIMIT,    "temBAD_SEND_XDV_LIMIT",    "Malformed: Limit quality is not allowed for XDV to XDV."       },
        { temBAD_SEND_XDV_MAX,      "temBAD_SEND_XDV_MAX",      "Malformed: Send max is not allowed for XDV to XDV."            },
        { temBAD_SEND_XDV_NO_DIRECT,"temBAD_SEND_XDV_NO_DIRECT","Malformed: No Ripple direct is not allowed for XDV to XDV."    },
        { temBAD_SEND_XDV_PARTIAL,  "temBAD_SEND_XDV_PARTIAL",  "Malformed: Partial payment is not allowed for XDV to XDV."     },
        { temBAD_SEND_XDV_PATHS,    "temBAD_SEND_XDV_PATHS",    "Malformed: Paths are not allowed for XDV to XDV."              },
